...
export const atualizar = async (req, res) => {
    try {
        ...
        if (req.body.escola !== undefined) exemplo.escola = req.body.escola;
        if (req.body.turma !== undefined) exemplo.turma = req.body.turma;
        if (req.body.foto !== undefined) exemplo.foto = req.body.foto;
